...
namespace BlogsMessageBus
{
    ...
    {
        private readonly string connectionString = "Endpoint=sb://blogsbus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=vWd/AYzt0r8Bg483PUH6Be3a0EiIOtE1f+ASbCWcoSg=";
